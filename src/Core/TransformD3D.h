#ifndef TRANSFORMD3D_H_DEFINED
#define TRANSFORMD3D_H_DEFINED
...
public:
    TransformD3D();
    ~TransformD3D() = default;

    TransformD3D(const TransformD3D& other);
    TransformD3D(TransformD3D&& other) noexcept;
    TransformD3D& operator=(const TransformD3D& other);
    TransformD3D& operator=(TransformD3D&& other) noexcept;
    ...
    void UpdateFromParent(TransformD3D const& parent);
